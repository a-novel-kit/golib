...
| `postgres`    | Carries the database handle on the request context, runs work inside transactions installed on it, and ships the migration runner.                                                                                                   |
| `postgres/postgrestest` | Provides disposable-database, isolated-schema, and migration-roundtrip harnesses for PostgreSQL-backed tests.                                                                                                                        |
