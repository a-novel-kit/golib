...
//
// Store the bodies a [Server] replays pretty-printed, so changing one shows up in review as the
// lines that changed rather than one long line swapped for another.
